...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SalesCycleProductStat.sales_cycle'
        db.alter_column('alma_cycle_prod_stat', 'sales_cycle_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['alm_crm.SalesCycle']))

    def backwards(self, orm):

        # Changing field 'SalesCycleProductStat.sales_cycle'
        db.alter_column('alma_cycle_prod_stat', 'sales_cycle_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['alm_crm.SalesCycle']))
