...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityFeedback.value'
        db.alter_column(u'alm_crm_activityfeedback', 'value_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_crm.Value'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'ActivityFeedback.value'
        db.alter_column(u'alm_crm_activityfeedback', 'value_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['alm_crm.Value'], unique=True))
