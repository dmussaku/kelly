...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityFeedback'
        db.create_table(u'alm_crm_activityfeedback', (
            ...
            ('value', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_crm.Value'], unique=True, blank=True)),
        ))
        db.send_create_signal(u'alm_crm', ['ActivityFeedback'])

        # Deleting field 'Activity.status'
        db.delete_column('alma_activity', 'status')

        # Deleting field 'Activity.when'
        db.delete_column('alma_activity', 'when')

        # Deleting field 'Activity.feedback'
        db.delete_column('alma_activity', 'feedback')

        # Adding field 'Activity.date_created'
        db.add_column('alma_activity', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 4, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'ActivityFeedback'
        db.delete_table(u'alm_crm_activityfeedback')

        # Adding field 'Activity.status'
        db.add_column('alma_activity', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Adding field 'Activity.when'
        db.add_column('alma_activity', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Activity.feedback'
        db.add_column('alma_activity', 'feedback',
                      self.gf('django.db.models.fields.CharField')(default='sample', max_length=300),
                      keep_default=False)
    ...
    models = {
        ...
        u'alm_crm.activityfeedback': {
            'Meta': {'object_name': 'ActivityFeedback'},
            ...
            'value': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['alm_crm.Value']", 'unique': 'True', 'blank': 'True'})
        },
        u'alm_crm.comment': {
