...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Comment.content_type' to match new field type.
        db.rename_column(u'alm_crm_comment', 'content_type', 'content_type_id')
        # Changing field 'Comment.content_type'
        db.alter_column(u'alm_crm_comment', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
        # Adding index on 'Comment', fields ['content_type']
        db.create_index(u'alm_crm_comment', ['content_type_id'])


    def backwards(self, orm):
        # Removing index on 'Comment', fields ['content_type']
        db.delete_index(u'alm_crm_comment', ['content_type_id'])


        # Renaming column for 'Comment.content_type' to match new field type.
        db.rename_column(u'alm_crm_comment', 'content_type_id', 'content_type')
        # Changing field 'Comment.content_type'
        db.alter_column(u'alm_crm_comment', 'content_type', self.gf('django.db.models.fields.CharField')(max_length=1000))
