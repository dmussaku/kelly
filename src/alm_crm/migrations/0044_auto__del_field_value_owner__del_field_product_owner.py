...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('alma_value', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_values', null=True, to=orm['alm_crm.CRMUser'], blank=True),
                      keep_default=False)

        # Adding field 'Product.owner'
        db.add_column('alma_product', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='crm_products', null=True, to=orm['alm_crm.CRMUser'], blank=True),
                      keep_default=False)
