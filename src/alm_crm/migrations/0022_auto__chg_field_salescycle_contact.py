...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SalesCycle.contact'
        db.alter_column('alma_sales_cycle', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, on_delete=models.SET_DEFAULT, to=orm['alm_crm.Contact']))
