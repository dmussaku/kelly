...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesCycleLogEntry.date_created'
        db.add_column(u'alm_crm_salescyclelogentry', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SalesCycleLogEntry.date_edited'
        db.add_column(u'alm_crm_salescyclelogentry', 'date_edited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalesCycleLogEntry.date_created'
        db.delete_column(u'alm_crm_salescyclelogentry', 'date_created')

        # Deleting field 'SalesCycleLogEntry.date_edited'
        db.delete_column(u'alm_crm_salescyclelogentry', 'date_edited')
