...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mention.date_created'
        db.add_column(u'alm_crm_mention', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 23, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Product.date_created'
        db.add_column('alma_product', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 23, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ContactList.date_created'
        db.add_column('alma_contact_list', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mention.date_created'
        db.delete_column(u'alm_crm_mention', 'date_created')

        # Deleting field 'Product.date_created'
        db.delete_column('alma_product', 'date_created')

        # Deleting field 'ContactList.date_created'
        db.delete_column('alma_contact_list', 'date_created')
