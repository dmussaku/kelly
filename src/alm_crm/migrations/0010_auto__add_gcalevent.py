...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GCalEvent'
        db.create_table('third_party_google_cal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_id', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gcal_events', null=True, to=orm['alm_crm.Activity'])),
        ))
        db.send_create_signal(u'alm_crm', ['GCalEvent'])


    def backwards(self, orm):
        # Deleting model 'GCalEvent'
        db.delete_table('third_party_google_cal')
    ...
    models = {
        u'alm_crm.activity': {
            ...
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activities'", 'null': 'True', 'to': u"orm['alm_crm.Milestone']"}),
        ...
        u'alm_crm.gcalevent': {
            'Meta': {'object_name': 'GCalEvent', 'db_table': "'third_party_google_cal'"},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gcal_events'", 'null': 'True', 'to': u"orm['alm_crm.Activity']"}),
            'event_id': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'alm_crm.hashtag': {
