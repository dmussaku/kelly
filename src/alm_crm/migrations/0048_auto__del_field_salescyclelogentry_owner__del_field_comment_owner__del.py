...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'alm_crm_salescyclelogentry', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_logentries', null=True, to=orm['alm_crm.CRMUser']),
                      keep_default=False)
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Comment.owner'
        db.add_column(u'alm_crm_comment', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_owner', to=orm['alm_crm.CRMUser']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Filter.owner'
        raise RuntimeError("Cannot reverse this migration. 'Filter.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Filter.owner'
        db.add_column('alma_filter', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_filter', to=orm['alm_crm.CRMUser']),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'SalesCycle.owner'
        raise RuntimeError("Cannot reverse this migration. 'SalesCycle.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SalesCycle.owner'
        db.add_column('alma_sales_cycle', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_sales_cycles', to=orm['alm_crm.CRMUser']),
                      keep_default=False)

        # Adding field 'ContactList.owner'
        db.add_column('alma_contact_list', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_list', null=True, to=orm['alm_crm.CRMUser'], blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Activity.owner'
        raise RuntimeError("Cannot reverse this migration. 'Activity.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Activity.owner'
        db.add_column('alma_activity', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_owner', to=orm['alm_crm.CRMUser']),
                      keep_default=False)

        # Adding field 'ProductGroup.owner'
        db.add_column('alma_product_group', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_product_groups', null=True, to=orm['alm_crm.CRMUser'], blank=True),
                      keep_default=False)
    ...
    models = {
        u'alm_crm.activity': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activity_owner_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.comment': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_owner_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.contactlist': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_list_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.filter': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_filter_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.mention': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_mentions_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.productgroup': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_product_groups_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'alm_crm.salescycle': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_sales_cycles_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.salescyclelogentry': {
            ...
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_logentries_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
