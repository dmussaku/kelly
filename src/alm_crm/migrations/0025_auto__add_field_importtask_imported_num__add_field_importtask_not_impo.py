...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportTask.imported_num'
        db.add_column(u'alm_crm_importtask', 'imported_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ImportTask.not_imported_num'
        db.add_column(u'alm_crm_importtask', 'not_imported_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ContactList.import_task'
        db.add_column('alma_contact_list', 'import_task',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_crm.ImportTask'], unique=True, null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportTask.imported_num'
        db.delete_column(u'alm_crm_importtask', 'imported_num')

        # Deleting field 'ImportTask.not_imported_num'
        db.delete_column(u'alm_crm_importtask', 'not_imported_num')

        # Deleting field 'ContactList.import_task'
        db.delete_column('alma_contact_list', 'import_task_id')
    ...
    models = {
        ...
        u'alm_crm.importtask': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imported_num': ('django.db.models.fields.IntegerField', [], {}),
            'not_imported_num': ('django.db.models.fields.IntegerField', [], {}),
