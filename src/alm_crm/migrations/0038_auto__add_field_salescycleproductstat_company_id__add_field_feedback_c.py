...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # # Adding field 'Feedback.company_id'
        # db.add_column(u'alm_crm_feedback', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # # Adding field 'SalesCycleLogEntry.company_id'
        # db.add_column(u'alm_crm_salescyclelogentry', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # # Adding field 'Comment.company_id'
        # db.add_column(u'alm_crm_comment', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # # Adding field 'Milestone.company_id'
        # db.add_column('alma_milestone', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'CRMUser.company_id'
        # db.add_column(u'alm_crm_crmuser', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'Filter.company_id'
        # db.add_column('alma_filter', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Changing field 'ActivityRecipient.user'
        # db.alter_column('alma_activity_recipient', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_user.User']))
        ...
        # Adding field 'CustomFieldValue.company_id'
        # db.add_column('alma_custom_field_values', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'HashTagReference.company_id'
        # db.add_column('alma_hashtag_reference', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'SalesCycle.company_id'
        # db.add_column('alma_sales_cycle', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Adding field 'ContactList.company_id'
        # db.add_column('alma_contact_list', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Adding field 'Value.company_id'
        # db.add_column('alma_value', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Adding field 'Activity.company_id'
        # db.add_column('alma_activity', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Adding field 'Share.company_id'
        # db.add_column('alma_share', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'CustomField.company_id'
        # db.add_column('alma_custom_fields', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'Contact.company_id'
        # db.add_column('alma_contact', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
        ...
        # Adding field 'CustomSection.company_id'
        # db.add_column('alma_custom_sections', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)

        # # Adding field 'ProductGroup.company_id'
        # db.add_column('alma_product_group', 'company_id',
        #               self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
        #               keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SalesCycleProductStat.company_id'
        db.delete_column('alma_cycle_prod_stat', 'company_id')

        # Deleting field 'Feedback.company_id'
        db.delete_column(u'alm_crm_feedback', 'company_id')


        # Changing field 'Feedback.owner'
        db.alter_column(u'alm_crm_feedback', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'SalesCycleLogEntry.company_id'
        db.delete_column(u'alm_crm_salescyclelogentry', 'company_id')
        ...
        # Deleting field 'Comment.company_id'
        db.delete_column(u'alm_crm_comment', 'company_id')


        # Changing field 'Comment.owner'
        db.alter_column(u'alm_crm_comment', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'Milestone.company_id'
        db.delete_column('alma_milestone', 'company_id')

        # Deleting field 'CRMUser.company_id'
        db.delete_column(u'alm_crm_crmuser', 'company_id')

        # Deleting field 'Filter.company_id'
        db.delete_column('alma_filter', 'company_id')


        # Changing field 'Filter.owner'
        db.alter_column('alma_filter', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'ActivityRecipient.company_id'
        db.delete_column('alma_activity_recipient', 'company_id')


        # Changing field 'ActivityRecipient.user'
        db.alter_column('alma_activity_recipient', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'Mention.company_id'
        db.delete_column(u'alm_crm_mention', 'company_id')
        ...
        # Deleting field 'CustomFieldValue.company_id'
        db.delete_column('alma_custom_field_values', 'company_id')

        # Deleting field 'HashTagReference.company_id'
        db.delete_column('alma_hashtag_reference', 'company_id')

        # Deleting field 'SalesCycle.company_id'
        db.delete_column('alma_sales_cycle', 'company_id')


        # Changing field 'SalesCycle.owner'
        db.alter_column('alma_sales_cycle', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'ContactList.company_id'
        db.delete_column('alma_contact_list', 'company_id')
        ...
        # Deleting field 'Value.company_id'
        db.delete_column('alma_value', 'company_id')


        # Changing field 'Value.owner'
        db.alter_column('alma_value', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alm_crm.CRMUser']))
        # Deleting field 'Activity.company_id'
        db.delete_column('alma_activity', 'company_id')


        # Changing field 'Activity.owner'
        db.alter_column('alma_activity', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.CRMUser']))
        # Deleting field 'Share.company_id'
        db.delete_column('alma_share', 'company_id')

        # Deleting field 'CustomField.company_id'
        db.delete_column('alma_custom_fields', 'company_id')

        # Deleting field 'Contact.company_id'
        db.delete_column('alma_contact', 'company_id')
        ...
        # Deleting field 'CustomSection.company_id'
        db.delete_column('alma_custom_sections', 'company_id')

        # Deleting field 'ProductGroup.company_id'
        db.delete_column('alma_product_group', 'company_id')
    ...
    models = {
        u'alm_crm.activity': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activity_owner'", 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.comment': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_owner'", 'to': u"orm['alm_user.User']"}),
            'subscription_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'alm_crm.contact': {
            'Meta': {'object_name': 'Contact', 'db_table': "'alma_contact'"},
            'another_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'another_owned_contacts'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'alm_crm.feedback': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feedback_owner'", 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.filter': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_filter'", 'to': u"orm['alm_user.User']"}),
            'subscription_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.productgroup': {
            ...
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_product_groups'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.salescycle': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_sales_cycles'", 'to': u"orm['alm_user.User']"}),
