...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomField.section'
        db.delete_column('alma_custom_fields', 'section_id')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feedback.date_edited'
        db.alter_column(u'alm_crm_feedback', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        ...
        # Changing field 'Comment.date_edited'
        db.alter_column(u'alm_crm_comment', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        ...
        # Adding field 'CustomField.value'
        db.add_column('alma_custom_fields', 'value',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomField.section'
        db.add_column('alma_custom_fields', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_fields', null=True, to=orm['alm_crm.CustomSection'], blank=True),
                      keep_default=False)

        # Adding field 'CustomField.object_id'
        db.add_column('alma_custom_fields', 'object_id',
