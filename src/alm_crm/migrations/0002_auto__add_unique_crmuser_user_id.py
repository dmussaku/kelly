...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CRMUser', fields ['user_id']
        db.create_unique(u'alm_crm_crmuser', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CRMUser', fields ['user_id']
        db.delete_unique(u'alm_crm_crmuser', ['user_id'])
