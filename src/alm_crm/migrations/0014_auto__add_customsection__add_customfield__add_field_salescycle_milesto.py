...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SalesCycle.milestone'
        db.add_column('alma_sales_cycle', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sales_cycles', null=True, to=orm['alm_crm.Milestone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalesCycle.milestone'
        db.delete_column('alma_sales_cycle', 'milestone_id')
