...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        u_ids = [x.id for x in orm['alm_user.User'].objects.all()]
        actrs = orm.ActivityRecipient.objects.exclude(user_id__in=u_ids)
        actrs.delete()
        sql = db.foreign_key_sql('alma_activity_recipient', 'user_id', 'alma_user', 'id')
        db.execute(sql)

    def backwards(self, orm):
        db.delete_foreign_key('alma_activity_recipient', 'user_id')
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
