...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['latest_activity']
        db.delete_unique('alma_contact', ['latest_activity_id'])

        # Removing unique constraint on 'SalesCycle', fields ['latest_activity']
        db.delete_unique('alma_sales_cycle', ['latest_activity_id'])


        # Changing field 'SalesCycle.latest_activity'
        db.alter_column('alma_sales_cycle', 'latest_activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alm_crm.Activity'], null=True))

        # Changing field 'Contact.latest_activity'
        db.alter_column('alma_contact', 'latest_activity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alm_crm.Activity']))

    def backwards(self, orm):

        # Changing field 'SalesCycle.latest_activity'
        db.alter_column('alma_sales_cycle', 'latest_activity_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_crm.Activity'], unique=True, null=True, on_delete=models.SET_NULL))
        # Adding unique constraint on 'SalesCycle', fields ['latest_activity']
        db.create_unique('alma_sales_cycle', ['latest_activity_id'])


        # Changing field 'Contact.latest_activity'
        db.alter_column('alma_contact', 'latest_activity_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, on_delete=models.SET_NULL, to=orm['alm_crm.Activity']))
        # Adding unique constraint on 'Contact', fields ['latest_activity']
        db.create_unique('alma_contact', ['latest_activity_id'])
    ...
    models = {
        ...
        u'alm_crm.contact': {
            ...
            'latest_activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contact_latest_activity'", 'null': 'True', 'to': u"orm['alm_crm.Activity']"}),
        ...
        u'alm_crm.filter': {
            ...
            'base': ('django.db.models.fields.CharField', [], {'default': "'allbase'", 'max_length': '8'}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.notification': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
        ...
        u'alm_crm.salescycle': {
            ...
            'latest_activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['alm_crm.Activity']", 'null': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.salescycleproductstat': {
            ...
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_stats'", 'to': u"orm['alm_crm.Product']"}),
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
