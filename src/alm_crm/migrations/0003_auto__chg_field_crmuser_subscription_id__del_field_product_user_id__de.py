...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CRMUser.subscription_id'
        db.alter_column(u'alm_crm_crmuser', 'subscription_id', self.gf('django.db.models.fields.IntegerField')(null=True))
        ...
        db.add_column('alma_product', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='crm_products', null=True, to=orm['alm_crm.CRMUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CRMUser.subscription_id'
        db.alter_column(u'alm_crm_crmuser', 'subscription_id', self.gf('django.db.models.fields.IntegerField')(default=None))
