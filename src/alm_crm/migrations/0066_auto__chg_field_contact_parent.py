...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.parent'
        db.alter_column('alma_contact', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['alm_crm.Contact']))

    def backwards(self, orm):

        # Changing field 'Contact.parent'
        db.alter_column('alma_contact', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alm_crm.Contact']))
