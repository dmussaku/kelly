...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportTask.uuid'
        db.alter_column(u'alm_crm_importtask', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ImportTask.uuid'
        db.alter_column(u'alm_crm_importtask', 'uuid', self.gf('django.db.models.fields.CharField')(default='111111111', max_length=100))
