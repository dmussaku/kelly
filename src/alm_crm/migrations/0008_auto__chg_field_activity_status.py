...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.status'
        db.alter_column('alma_activity', 'status', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Activity.status'
        db.alter_column('alma_activity', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))
