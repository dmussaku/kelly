...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mention.user_id'
        db.delete_column(u'alm_crm_mention', 'user_id')

        # Adding field 'Mention.user'
        db.add_column(u'alm_crm_mention', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mentions', null=True, to=orm['alm_crm.CRMUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Mention.user_id'
        db.add_column(u'alm_crm_mention', 'user_id',
    ...
    models = {
        ...
        u'alm_crm.salescycle': {
            ...
            'projected_value': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'_unused_1_sales_cycle'", 'unique': 'True', 'null': 'True', 'to': u"orm['alm_crm.Value']"}),
