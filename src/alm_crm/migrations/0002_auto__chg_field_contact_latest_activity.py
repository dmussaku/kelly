...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contact.latest_activity'
        db.alter_column('alma_contact', 'latest_activity_id', self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.datetime(2014, 8, 26, 0, 0), unique=True, to=orm['alm_crm.Activity']))
