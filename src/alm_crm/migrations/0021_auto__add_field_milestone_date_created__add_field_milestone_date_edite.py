...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Milestone.date_created'
        db.delete_column('alma_milestone', 'date_created')

        # Deleting field 'Milestone.date_edited'
        db.delete_column('alma_milestone', 'date_edited')

        # Deleting field 'Filter.date_edited'
        db.delete_column('alma_filter', 'date_edited')
        ...
        # Deleting field 'ActivityRecipient.date_created'
        db.delete_column('alma_activity_recipient', 'date_created')

        # Deleting field 'ActivityRecipient.date_edited'
        db.delete_column('alma_activity_recipient', 'date_edited')

        # Deleting field 'Share.date_edited'
        db.delete_column('alma_share', 'date_edited')
        ...
        # Deleting field 'HashTag.date_created'
        db.delete_column('alma_hashtag', 'date_created')

        # Deleting field 'HashTag.date_edited'
        db.delete_column('alma_hashtag', 'date_edited')

        # Deleting field 'CRMUser.date_created'
        db.delete_column(u'alm_crm_crmuser', 'date_created')

        # Deleting field 'CRMUser.date_edited'
        db.delete_column(u'alm_crm_crmuser', 'date_edited')

        # Deleting field 'CustomSection.date_edited'
        db.delete_column('alma_custom_sections', 'date_edited')
        ...
        # Deleting field 'SalesCycleProductStat.date_created'
        db.delete_column('alma_cycle_prod_stat', 'date_created')

        # Deleting field 'SalesCycleProductStat.date_edited'
        db.delete_column('alma_cycle_prod_stat', 'date_edited')
        ...
        # Changing field 'Feedback.date_edited'
        db.alter_column(u'alm_crm_feedback', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 12, 0, 0)))
        # Deleting field 'CustomField.date_edited'
        db.delete_column('alma_custom_fields', 'date_edited')
        ...
        # Deleting field 'Mention.date_edited'
        db.delete_column(u'alm_crm_mention', 'date_edited')
        ...
        # Changing field 'SalesCycleLogEntry.date_edited'
        db.alter_column(u'alm_crm_salescyclelogentry', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
        # Deleting field 'Contact.date_edited'
        db.delete_column('alma_contact', 'date_edited')
        ...
        # Deleting field 'HashTagReference.date_edited'
        db.delete_column('alma_hashtag_reference', 'date_edited')
        ...
        # Changing field 'Comment.date_edited'
        db.alter_column(u'alm_crm_comment', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 12, 0, 0)))
        # Deleting field 'SalesCycle.date_edited'
        db.delete_column('alma_sales_cycle', 'date_edited')
        ...
        # Deleting field 'ContactList.date_edited'
        db.delete_column('alma_contact_list', 'date_edited')
        ...
        # Deleting field 'ProductGroup.date_edited'
        db.delete_column('alma_product_group', 'date_edited')
        ...
        # Deleting field 'Product.date_edited'
        db.delete_column('alma_product', 'date_edited')
        ...
        # Deleting field 'Value.date_created'
        db.delete_column('alma_value', 'date_created')

        # Deleting field 'Value.date_edited'
        db.delete_column('alma_value', 'date_edited')


        # Changing field 'Activity.date_edited'
        db.alter_column('alma_activity', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
