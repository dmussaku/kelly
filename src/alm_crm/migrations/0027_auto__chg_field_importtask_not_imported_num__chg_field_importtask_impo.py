...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportTask.not_imported_num'
        db.alter_column(u'alm_crm_importtask', 'not_imported_num', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ImportTask.imported_num'
        db.alter_column(u'alm_crm_importtask', 'imported_num', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ImportTask.not_imported_num'
        db.alter_column(u'alm_crm_importtask', 'not_imported_num', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ImportTask.imported_num'
        db.alter_column(u'alm_crm_importtask', 'imported_num', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'alm_crm.importtask': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imported_num': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'not_imported_num': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
