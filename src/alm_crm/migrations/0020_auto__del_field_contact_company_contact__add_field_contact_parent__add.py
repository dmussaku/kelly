...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.parent'
        db.add_column('alma_contact', 'parent',
    ...
    def backwards(self, orm):
        ...
        db.add_column('alma_contact', 'company_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_contacts', null=True, to=orm['alm_crm.Contact'], blank=True),
                      keep_default=False)

        # Deleting field 'Contact.parent'
        db.delete_column('alma_contact', 'parent_id')
