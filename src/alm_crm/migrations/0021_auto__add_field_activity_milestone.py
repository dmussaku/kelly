...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.milestone'
        db.add_column('alma_activity', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='activities', null=True, to=orm['alm_crm.Milestone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.milestone'
        db.delete_column('alma_activity', 'milestone_id')
