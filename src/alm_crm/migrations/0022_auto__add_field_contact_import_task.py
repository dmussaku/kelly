...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.import_task'
        db.add_column('alma_contact', 'import_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contacts', null=True, to=orm['alm_crm.ImportTask']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.import_task'
        db.delete_column('alma_contact', 'import_task_id')
    ...
    models = {
        ...
        u'alm_crm.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_task': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contacts'", 'null': 'True', 'to': u"orm['alm_crm.ImportTask']"}),
