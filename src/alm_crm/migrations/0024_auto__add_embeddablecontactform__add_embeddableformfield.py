...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alma_embeddable_form_field', (
            ...
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields', to=orm['alm_crm.EmbeddableContactForm'])),
        ))
    ...
    models = {
        ...
        u'alm_crm.embeddablecontactform': {
            'Meta': {'object_name': 'EmbeddableContactForm', 'db_table': "'alma_embeddable_contact_form'"},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inlineCSS': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'null': 'True', 'blank': 'True'}),
        ...
        u'alm_crm.embeddableformfield': {
            'Meta': {'object_name': 'EmbeddableFormField', 'db_table': "'alma_embeddable_form_field'"},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fields'", 'to': u"orm['alm_crm.EmbeddableContactForm']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
