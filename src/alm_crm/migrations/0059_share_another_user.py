...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for s in orm.Share.objects.all():
            crm_user = orm.CRMUser.objects.get(pk=s.share_to_id)
            s.another_share_to_id = crm_user.user_id
            crm_user = orm.CRMUser.objects.get(pk=s.share_from_id)
            s.another_share_from_id = crm_user.user_id
            s.save()
