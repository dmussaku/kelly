...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Filter.base'
        db.alter_column('alma_filter', 'base', self.gf('django.db.models.fields.CharField')(max_length=8))

    def backwards(self, orm):

        # Changing field 'Filter.base'
        db.alter_column('alma_filter', 'base', self.gf('django.db.models.fields.CharField')(max_length=6))
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
