...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alma_share', 'description')

        # Adding field 'Share.note'
        db.add_column('alma_share', 'note',
    ...
    def backwards(self, orm):
        ...
        db.add_column('alma_share', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)

        # Deleting field 'Share.note'
        db.delete_column('alma_share', 'note')
