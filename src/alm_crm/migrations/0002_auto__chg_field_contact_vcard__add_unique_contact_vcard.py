...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('alma_contact', 'vcard_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_vcard.VCard'], unique=True, null=True))
        # Adding unique constraint on 'Contact', fields ['vcard']
        db.create_unique('alma_contact', ['vcard_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['vcard']
        db.delete_unique('alma_contact', ['vcard_id'])
