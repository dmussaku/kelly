...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for crm_user in orm['alm_crm.CRMUser'].objects.all():
            try:
                crm_user.owned_sales_cycles.get(is_global=True)
            except:
                cycle = orm['alm_crm.SalesCycle']()
                cycle.is_global = True
                cycle.title = 'global'
                cycle.description = ''
                cycle.owner = crm_user
                cycle.save()
