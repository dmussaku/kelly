...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsersGroup'
        db.create_table(u'alm_crm_usersgroup', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_groups', null=True, to=orm['alm_user.User'])),
        ))
        db.send_create_signal(u'alm_crm', ['UsersGroup'])

        # Adding M2M table for field users on 'UsersGroup'
        m2m_table_name = db.shorten_name(u'alm_crm_usersgroup_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usersgroup', models.ForeignKey(orm[u'alm_crm.usersgroup'], null=False)),
            ('user', models.ForeignKey(orm[u'alm_user.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usersgroup_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'UsersGroup'
        db.delete_table(u'alm_crm_usersgroup')

        # Removing M2M table for field users on 'UsersGroup'
        db.delete_table(db.shorten_name(u'alm_crm_usersgroup_users'))
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
