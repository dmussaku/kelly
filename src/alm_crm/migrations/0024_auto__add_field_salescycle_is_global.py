...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesCycle.is_global'
        db.add_column('alma_sales_cycle', 'is_global',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalesCycle.is_global'
        db.delete_column('alma_sales_cycle', 'is_global')
