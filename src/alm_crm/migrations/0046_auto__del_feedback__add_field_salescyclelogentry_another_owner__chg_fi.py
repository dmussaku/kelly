...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_contact_list', 'another_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_list_x', null=True, to=orm['alm_user.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'alm_crm_feedback', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_owner', to=orm['alm_user.User'])),
