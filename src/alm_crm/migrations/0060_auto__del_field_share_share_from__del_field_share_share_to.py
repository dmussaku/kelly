...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Share.share_from'
        raise RuntimeError("Cannot reverse this migration. 'Share.share_from' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Share.share_from'
        db.add_column('alma_share', 'share_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_shares', to=orm['alm_crm.CRMUser']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Share.share_to'
        raise RuntimeError("Cannot reverse this migration. 'Share.share_to' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Share.share_to'
        db.add_column('alma_share', 'share_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='in_shares', to=orm['alm_crm.CRMUser']),
                      keep_default=False)
    ...
    models = {
        ...
        u'alm_crm.share': {
            ...
            'another_share_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_shares_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'another_share_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'in_shares_x'", 'null': 'True', 'to': u"orm['alm_user.User']"}),
            'company_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
