...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for c in orm['alm_company.Company'].objects.all():
            orm.ActivityRecipient.objects.filter(activity__company_id=c.id).update(company_id=c.id)
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
    ...
    complete_apps = ['alm_company', 'alm_crm']
    symmetrical = True
