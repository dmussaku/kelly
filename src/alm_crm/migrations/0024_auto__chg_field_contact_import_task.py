...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.import_task'
        db.alter_column('alma_contact', 'import_task_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['alm_crm.ImportTask']))

    def backwards(self, orm):

        # Changing field 'Contact.import_task'
        db.alter_column('alma_contact', 'import_task_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alm_crm.ImportTask']))
