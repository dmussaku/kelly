...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttachedFile.content_type'
        db.alter_column('alm_crm_attachedfile', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['contenttypes.ContentType']))

    def backwards(self, orm):
        # Changing field 'AttachedFile.object_id'        
        b.alter_column(u'alm_crm_attachedfile', 'object_id', self.gf('django.db.models.fields.IntegerField')())
        
        # Changing field 'AttachedFile.content_type'
        db.alter_column('alm_crm_attachedfile', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'alm_crm.attachedfile': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_attachments'", 'null': 'True', 'to': u"orm['alm_crm.CRMUser']"}),
            'subscription_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'alm_crm.comment': {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
