...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedback.feedback'
        db.alter_column(u'alm_crm_feedback', 'feedback', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Feedback.feedback'
        db.alter_column(u'alm_crm_feedback', 'feedback', self.gf('django.db.models.fields.CharField')(default=None, max_length=300))
