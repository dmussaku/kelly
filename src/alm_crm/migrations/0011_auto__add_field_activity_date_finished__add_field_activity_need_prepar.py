...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.date_finished'
        db.add_column('alma_activity', 'date_finished',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.need_preparation'
        db.add_column('alma_activity', 'need_preparation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.date_finished'
        db.delete_column('alma_activity', 'date_finished')

        # Deleting field 'Activity.need_preparation'
        db.delete_column('alma_activity', 'need_preparation')
