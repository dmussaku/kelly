...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_activity', 'assignee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_assignee', null=True, to=orm['alm_crm.CRMUser']),
                      keep_default=False)

        # Adding field 'Activity.result'
        db.add_column('alma_activity', 'result',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Activity.result'
        db.delete_column('alma_activity', 'result')
