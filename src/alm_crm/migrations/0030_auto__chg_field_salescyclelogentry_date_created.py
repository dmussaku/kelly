...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'alm_crm_salescyclelogentry', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'SalesCycleLogEntry.date_created'
        db.alter_column(u'alm_crm_salescyclelogentry', 'date_created', self.gf('django.db.models.fields.DateTimeField')())
