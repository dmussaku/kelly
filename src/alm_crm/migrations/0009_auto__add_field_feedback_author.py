...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'alm_crm_feedback', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_feedbacks', null=True, to=orm['alm_crm.CRMUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.author'
        db.delete_column(u'alm_crm_feedback', 'author_id')
    ...
    models = {
        ...
        u'alm_crm.feedback': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owned_feedbacks'", 'null': 'True', 'to': u"orm['alm_crm.CRMUser']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
