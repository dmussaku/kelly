...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        with transaction.atomic():
            for c in orm.Contact.objects.filter(tp='co'):
                titles = orm['alm_vcard.Title'].objects.filter(vcard_id=c.vcard.id)
                titles.delete()
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
    ...
    complete_apps = ['alm_vcard', 'alm_crm']
    symmetrical = True
