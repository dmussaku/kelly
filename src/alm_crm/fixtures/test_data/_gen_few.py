...
limits = [  # limits by subscription ids
    {'user': 3, 'contact': randint(100, 200), 'sales_cycle': randint(1, 3), 'activity': randint(1, 3), 'comment': randint(0, 4), 'products': 20},
    {'user': 2, 'contact': randint(100, 200), 'sales_cycle': randint(1, 3), 'activity': randint(1, 2), 'comment': randint(0, 3), 'products': 1000}
]
...
for index_subscr in range(0, len(limits)):
    ...
    for index_contact in range(0, limits[index_subscr]['contact']):
        ...
        for index_s in range(0, randint(1, 2)):
            ...
            for index_a in range(0, randint(1, 2)):
                ...
                for index_c in range(0, randint(0, 1)):
                    c_owner = gen_user_id()
...
for fname in f:
    ...
    fixture_file = open('%s_few.json' % (fname), 'w+')
