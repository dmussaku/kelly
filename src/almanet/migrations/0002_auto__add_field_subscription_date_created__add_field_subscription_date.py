...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.date_created'
        db.add_column('alma_subscription', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscription.date_edited'
        db.add_column('alma_subscription', 'date_edited',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.date_created'
        db.delete_column('alma_subscription', 'date_created')

        # Deleting field 'Subscription.date_edited'
        db.delete_column('alma_subscription', 'date_edited')
