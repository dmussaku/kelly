...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.global_sales_cycle_id'
        db.delete_column('alma_subscription', 'global_sales_cycle_id')


    def backwards(self, orm):
        # Adding field 'Subscription.global_sales_cycle_id'
        db.add_column('alma_subscription', 'global_sales_cycle_id',
