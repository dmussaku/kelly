...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('alma_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['alm_user.User']))

    def backwards(self, orm):

        # Changing field 'Subscription.user'
        db.alter_column('alma_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['alm_user.User']))
