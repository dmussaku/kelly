...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['product']
        db.delete_unique('alma_subscription', ['product_id'])


        # Changing field 'Subscription.product'
        db.alter_column('alma_subscription', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almanet.Product']))

    def backwards(self, orm):

        # Changing field 'Subscription.product'
        db.alter_column('alma_subscription', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['almanet.Product'], unique=True))
        # Adding unique constraint on 'Subscription', fields ['product']
        db.create_unique('alma_subscription', ['product_id'])
