...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscription.organization'
        db.delete_column('alma_subscription', 'organization_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('alma_subscription', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', null=True, to=orm['almanet.Plan'], blank=True),
                      keep_default=False)

        # Adding field 'Subscription.service'
        db.add_column('alma_subscription', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='subscriptions', to=orm['almanet.Service']),
                      keep_default=False)

        # Adding field 'Subscription.organization'
        db.add_column('alma_subscription', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='subscriptions', to=orm['alm_company.Company']),
                      keep_default=False)
    ...
    models = {
        ...
        u'almanet.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payments'", 'null': 'True', 'to': u"orm['almanet.Plan']"}),
