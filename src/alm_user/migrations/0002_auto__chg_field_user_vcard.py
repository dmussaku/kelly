...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.vcard'
        db.alter_column('alma_user', 'vcard_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_vcard.VCard'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'User.vcard'
        db.alter_column('alma_user', 'vcard_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_vcard.VCard'], unique=True, null=True))
