...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alma_account', 'password')

        # Deleting field 'Account.last_login'
        db.delete_column('alma_account', 'last_login')

        # Deleting field 'Account.email'
        db.delete_column('alma_account', 'email')


    def backwards(self, orm):
        # Adding field 'Account.password'
        db.add_column('alma_account', 'password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Account.last_login'
        db.add_column('alma_account', 'last_login',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Account.email'
        db.add_column('alma_account', 'email',
    ...
    models = {
        ...
        u'alm_user.user': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'False', 'max_length': '75', 'blank': 'True'}),
