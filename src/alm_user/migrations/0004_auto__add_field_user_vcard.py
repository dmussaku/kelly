...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.vcard'
        db.add_column('alma_user', 'vcard',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_vcard.VCard'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.vcard'
        db.delete_column('alma_user', 'vcard_id')
