...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('alma_account', ['email'])

        # Adding field 'Account.key'
        db.add_column('alma_account', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.key'
        db.delete_column('alma_account', 'key')

        # Adding unique constraint on 'Account', fields ['email']
        db.create_unique('alma_account', ['email'])
