...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_user', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.date_edited'
        db.add_column('alma_user', 'date_edited',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('alma_user', 'date_created')

        # Deleting field 'User.date_edited'
        db.delete_column('alma_user', 'date_edited')
