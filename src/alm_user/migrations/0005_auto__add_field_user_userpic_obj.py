...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_user', 'userpic_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['almastorage.SwiftFile'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.userpic_obj'
        db.delete_column('alma_user', 'userpic_obj_id')
    ...
    models = {
        ...
        u'alm_user.user': {
            ...
            'userpic_obj': ('django.db.models.fields.related.ForeignKey', [], {'default': '10', 'related_name': "'users'", 'to': u"orm['almastorage.SwiftFile']", 'null': 'True', 'blank': 'True'}),
        ...
        u'almastorage.swiftcontainer': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service_slug': ('django.db.models.fields.CharField', [], {'default': "'ALMASALES'", 'unique': 'False', 'max_length': '30'}),
