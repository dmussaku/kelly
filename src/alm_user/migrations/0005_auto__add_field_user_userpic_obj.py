...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_user', 'userpic_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, related_name='users', to=orm['almastorage.SwiftFile']),
                      keep_default=False)
    ...
    models = {
        ...
        u'alm_user.user': {
            ...
            'userpic_obj': ('django.db.models.fields.related.ForeignKey', [], {'default': '10', 'related_name': "'users'", 'to': u"orm['almastorage.SwiftFile']"}),
