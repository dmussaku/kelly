...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alma_user', 'language',
                      self.gf('django.db.models.fields.CharField')(default='ru-RU', max_length=30),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('alma_user', 'language')
    ...
    models = {
        ...
        u'almastorage.swiftfile': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
