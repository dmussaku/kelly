...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alma_account', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accounts', to=orm['alm_company.Company'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accounts', to=orm['alm_user.User'])),
            ('key', self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'alm_user', ['Account'])
        ...
        db.create_table('alma_user', (
            ...
            ('language', self.gf('django.db.models.fields.CharField')(default='ru-RU', max_length=30)),
            ('is_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('vcard', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['alm_vcard.VCard'], unique=True, null=True, blank=True)),
            ('userpic_obj', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='users', to=orm['almastorage.SwiftFile'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        db.create_table('alma_referral', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('referer', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'alm_user', ['Referral'])


    def backwards(self, orm):
        # Deleting model 'Account'
        db.delete_table('alma_account')
