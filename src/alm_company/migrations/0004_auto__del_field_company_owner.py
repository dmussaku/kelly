...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.owner'
        db.delete_column('alma_company', 'owner_id')
    ...
    def backwards(self, orm):
        # Adding field 'Company.owner'
        db.add_column('alma_company', 'owner',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='owned_company', unique=True, to=orm['alm_user.User']),
                      keep_default=False)
