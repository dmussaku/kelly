...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deposit.currency'
        db.add_column(u'alm_vcard_deposit', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='TG', max_length=100),
                      keep_default=False)


        # Changing field 'Deposit.date_created'
        db.alter_column(u'alm_vcard_deposit', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Loan.date_created'
        db.alter_column(u'alm_vcard_loan', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Deposit.currency'
        db.delete_column(u'alm_vcard_deposit', 'currency')


        # Changing field 'Deposit.date_created'
        db.alter_column(u'alm_vcard_deposit', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Loan.date_created'
        db.alter_column(u'alm_vcard_loan', 'date_created', self.gf('django.db.models.fields.DateTimeField')())
